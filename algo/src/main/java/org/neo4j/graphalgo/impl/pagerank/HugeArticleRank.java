 ...
 */
public class HugeArticleRank extends Algorithm<HugePageRank> implements PageRankAlgorithm {
     ...
     * {@link #HugeArticleRank(ExecutorService, int, int, AllocationTracker, HugeIdMapping, HugeNodeIterator, HugeRelationshipIterator, HugeDegrees, double)}
     */
    HugeArticleRank(
     ...
     */
    @Override
    public HugeArticleRank compute(int iterations) {
        assert iterations >= 1;
        initializeSteps();
    ...
    @Override
    public HugeArticleRank withLog(final Log log) {
        super.withLog(log);
        this.log = log;
        return this;
    }
    ...
    private ComputeSteps createComputeSteps(
        ...
        while (parts.hasNext()) {
            ...
            // TODO figure out if we should use the normal computeStepFactory here, or ArticleRankComputeStepFactory
    ...
    @Override
    public HugeArticleRank me() {
        return this;
    }

    @Override
    public HugeArticleRank release() {
